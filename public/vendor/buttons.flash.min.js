...
(function (g) {
  ...
  function N(a) {
    G === z &&
      (G =
        -1 ===
        J.serializeToString(g.parseXML(A["xl/worksheets/sheet1.xml"])).indexOf(
          "xmlns:r"
        ));
      ...
      if (g.isPlainObject(c)) N(c);
        ...
        if (G) {
          ...
          for (f = d.attributes.length - 1; 0 <= f; f--) {
            ...
            -1 !== n.indexOf(":") &&
              (e.push({ name: n, value: k }), d.removeAttribute(n));
          }
          f = 0;
  ...
  m.hasFlash = function () {
    try {
      ...
      if (
        navigator.mimeTypes &&
        navigator.mimeTypes["application/x-shockwave-flash"] !== z &&
  ...
  var O = function (a, b) {
    ...
    Q = function (a, b) {
      ...
      var d = b.fieldBoundary,
        ...
        k = function (u) {
          for (var x = "", B = 0, h = u.length; B < h; B++)
            0 < B && (x += f),
              (x += d ? d + ("" + u[B]).replace(e, n + d) + d : u[B]);
          return x;
        },
        E = b.header ? k(a.header) + c : "";
      b = b.footer && a.footer ? c + k(a.footer) : "";
      for (var C = [], p = 0, v = a.body.length; p < v; p++)
        C.push(k(a.body[p]));
  ...
  w.ext.buttons.excelFlash = g.extend({}, I, {
    ...
    action: function (a, b, c, d) {
          ...
          for (var l = 0, F = h.length; l < F; l++) {
            ...
            y ||
              ...
              (h[l].match &&
                ...
                ? (y = t(e, "c", {
                    attr: { t: "n", r: K },
                    children: [t(e, "v", { text: h[l] })],
                  }))
                : ((D = h[l].replace
                    ? h[l].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")
                    : h[l]),
                  (y = t(e, "c", {
                    attr: { t: "inlineStr", r: K },
                    children: {
                      row: t(e, "is", {
                        children: { row: t(e, "t", { text: D }) },
                      }),
                    },
                  }))));
            C.appendChild(y);
      ...
      var v = function (h, l) {
          ...
          F[0].appendChild(
            t(e, "mergeCell", { attr: { ref: "A" + h + ":" + M(l) + h } })
          );
      ...
      v = 0;
      for (x = k.header.length; v < x; v++)
        p.appendChild(
          t(e, "col", {
            attr: { min: v + 1, max: v + 1, width: S(k, v), customWidth: 1 },
          })
        );
