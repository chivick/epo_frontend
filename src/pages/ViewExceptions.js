...
function ViewException({ startLoading }) {
  ...
  useEffect(() => {
    const getSettlements = async () => {
      try {
        ...
        const response = await App.getSettlements(date);
  ...
  const downloadExcel = async () => {
    try {
      startLoading(true);
      const response = await App.downloadExceptionExcelFile("Exceptions", fileType,date,processName);
              ...
              <div className="row h-100">
                ...
                >
                  <div className="px-1 py-2">
                    <Header className="mb-2">View Exceptions</Header>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        ...
                        >
                          ...
                          {/* <option value="Fund Transfer Verve and Mastercard">
                            Fund Transfer Verve and Mastercard
                          </option> */}
                        </Select>
                      </div>
...
export default connect(null, actions)(ViewException);
