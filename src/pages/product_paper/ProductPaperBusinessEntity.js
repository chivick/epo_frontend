...
function ProductPaperBusinessEntity({ startLoading }) {
  ...
  const getEntity = async () => {
    try {
      ...
      await App.postRequest(urls.getEntity("BUSINESS GROUP")).then(result => {
  ...
  const deleteItem = async (e) => {
    try {
      ...
      await App.postRequest(urls.deleteEntity(selectedItem.Id, "BUSINESS GROUP"));
      getEntity();
              ...
              <div className="row h-100">
                ...
                >
                  <div className="px-1 py-2">
                    <Header className="mb-2">Business Groups</Header>
                  </div>
                  <div className="row">
...
export default connect(null, actions)(ProductPaperBusinessEntity);
