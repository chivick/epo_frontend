...
function ProductPaperDirectorateEntity({ startLoading }) {
  ...
  const getEntity = async () => {
    try {
      ...
      await App.postRequest(urls.getEntity("DIRECTORATE")).then(result => {
  ...
  const deleteItem = async (e) => {
    try {
      ...
      await App.postRequest(urls.deleteEntity(selectedItem.Id, "DIRECTORATE"));
      getEntity();
              ...
              <div className="row h-100">
                ...
                >
                  <div className="px-1 py-2">
                    <Header className="mb-2">Directorates</Header>
                  </div>
                  <div className="row">
...
export default connect(null, actions)(ProductPaperDirectorateEntity);
