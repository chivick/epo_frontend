...
function ReconRevalidation({ startLoading }) {
  ...
  // copied below function from dashboard to add close button to revalidation
          ...
          <SummaryBox style={{ padding: "16px" }}>
            ...
            <div className="table-responsive">
              <table className="logs-table table" style={{ width: "100%" }}>
                ...
                <tbody>
                  {pendingDispute &&
                    pendingDispute.filter((item)=>item.IsRevalidation === "True" || item.IsRevalidation === "true" || item.IsRevalidation === true).map((item, i) => {
                      return (
                        <tr key={i}>
...
export default connect(null, actions)(ReconRevalidation);
