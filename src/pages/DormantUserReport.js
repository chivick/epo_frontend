...
function DormantUserReport ({startLoading}){
  ...
  const getReport = () => {
    ...
    startLoading(true);
    App.getRequest(urls.dormantUsers).then(result => {
      if (result !== undefined) {
    ...
    window.$("#example").DataTable({
      ...
      columns: [
        ...
        },
        {
          ...
          render: (data, type, row, meta) => {
            if (type === "display") {
              return row.LastLogin ? moment(row.LastLogin).format("yyyy/MM/DD hh:mm") : "" ;
            }
            return row.LastLogin ? moment(row.LastLogin).format("yyyy/MM/DD hh:mm") : "" ;
          },
          responsivePriority: 3,
                ...
                <div className="row h-100">
                  ...
                  >
                    <div className="px-1 py-2">
                      <Header className="mb-2">Dormant User Report</Header>
...
export default connect(null, actions)(DormantUserReport);
