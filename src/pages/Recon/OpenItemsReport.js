...
function OpenItemsReport ({startLoading}){
  ...
  const getReport = () => {
    ...
    startLoading(true);
    App.getRequest(urls.filterOpenItemsReport(_type, dateSelected)).then(result => {
      if (result !== undefined) {
        setReports(result);
                ...
                <div className="row h-100">
                  ...
                  >
                    <div className="px-1 py-2">
                      <Header className="mb-2">Open Items Report</Header>
                      <div className="row px-4 mb-2">
                        <div className="col-md-4">
                          ...
                          >
                            ...
                            <option value="Success">Open Items used during recon</option>
                            <option value="Pending">Open Items not used for recon</option>
                            <option value="Failed">Open Items found but not used for recon</option>
                          </Select>
                        </div>
...
export default connect(null, actions)(OpenItemsReport);
