...
function GRU({ startLoading }) {
  ...
  const submitForm = async (e) => {
    try {
      ...
      App.postRequestFile("Recon/UploadGRUFile?process=" + process , data).then(result => {
              ...
              <div className="row h-100">
                ...
                >
                  <div className="px-1 py-2">
                    <Header className="mb-2">GRU Open Items Report</Header>
                  </div>
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      >
                        ...
                        <option value="OpenItemsFailedAgency">Agency Banking</option>
                        <option value="OpenItemsVerve">ATM</option>
                        <option value="OpenItemsVerve">POS/Web</option>
                        {/* <option value="OpenItemsMastercard">Mastercard</option> */}
...
export default connect(null, actions)(GRU);
