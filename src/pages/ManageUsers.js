...
function ManageUsers({ startLoading }) {
  ...
  const changeUserStatus = async (user, status) => {
    try {
      startLoading(true);
      await App.changeUserAvailiability(user.StaffId, status);
  ...
  const resetUser = (value) => {
    startLoading(true);
    App.postRequest(urls.resetUser, {staffId: user.StaffId}).then(result => {
      if (result.Status) {
  ...
  const myStaffId = App.getFromLocalStorage("fb-staffId");

  log("initial", "res", [...appConstants.maker, appConstants.admin[1]].includes(App.getUserRole()));
            ...
            <table className="logs-table" style={{ width: "100%" }}>
              ...
              <tbody>
                {users.map((user) => {
                  ...
                  if ([...appConstants.maker, ...appConstants.checker, appConstants.admin[0]].includes(user.Role)) {
                    return;
                  }
                  
                  if ((![appConstants.admin[0]].includes(user.Role)) || (user.Id == myStaffId)) {
                  return (
                  <UserTableRow
                    key={user.Id}
                    userId={user.StaffId}
                    ...
                    deleteUserClick={[...appConstants.maker].includes(App.getUserRole()) ? () => deleteUserClick(user) : undefined}
                  />
                )
              }
              })}
              ...
              <div className="row mt-3 px-4 pb-5">
                <div className="col-md-6">
                  ...
                  >
                    ...
                    {
                      [...appConstants.maker, appConstants.admin[1]].includes(App.getUserRole()) &&
                      <>
              ...
              <div className="row mt-3 px-4 pb-5">
                <div className="col-md-6">
                  ...
                  >
                    ...
                    {
                      [...appConstants.admin, ...appConstants.maker, ...appConstants.checker].includes(App.getUserRole()) &&
                      <>
                        <option value={appConstants.maker[0]}>ISOD Maker</option>
                        <option value={appConstants.checker[0]}>ISOD Checker</option>
            ...
            <div class="modal-body p-0">
              ...
              <div className="row mt-3 px-4 pb-5">
                      ...
                      disabled={(![...appConstants.maker].includes(App.getUserRole()))}
                        onChange={() => {
                          if (
                            ...
                            // if ([appConstants.admin[1]].includes(App.getUserRole())) {
                ...
                <div className="col-md-4">
                  ...
                  <div style={{ width: 170 }} className="pt-2">
...
export default connect(null, actions)(ManageUsers);
