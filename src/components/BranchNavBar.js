    ...
    <NavContainer>
      ...
      <section className="nav-bar-section2" >
        <ul style={{paddingTop: 0, paddingRight: 2, paddingBottom: 0, paddingLeft: 2}}>
          ...
          {["Checker", appConstants.admin[1]].includes(App.getUserRole()) && (
            <li>
          ...
          {[...appConstants.maker, ...appConstants.checker, appConstants.admin[1]].includes(App.getUserRole()) ? (
            <li>
